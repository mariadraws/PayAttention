...
public class OVRScreenFade : MonoBehaviour {
  ...
  /// <summary>
  /// Call This for custom Fades
  /// </summary>
  public void CustomFade (float startAlpha, float endAlpha) {
    if (!isFading) StartCoroutine(Fade(startAlpha, endAlpha));
    else Debug.Log("Failed To Fade as it's already fading");
  }
